...
#joint contract KT1ByJAPmjqY2aDobZRCEgccdaxSidAs1ZPA
...
class JennyNFT(sp.Contract):
    def __init__(self, admin_1, admin_2, metadata):
        self.init(
            ...
            paused=False,
            administrator_1=admin_1,
            administrator_2=admin_2,
            metadata=metadata,
    ...
    def is_administrator(self, sender):
        sp.if (sender == self.data.administrator_1):
            return True
        sp.else: 
            sp.if (sender == self.data.administrator_2):
                return True
            sp.else:
                return False
    ...
    def set_administrator(self, params):
        ...
        self.data.administrator_1 = params
...
if "templates" not in __name__:
    ...
    def test():
        ...
        admin_1 = sp.address("tz1eoiykKbb4uvZxdTUPZDdwx7ssqDG6od9g")
        admin_2 = sp.address("tz1fpnifeuNBXc9R4s9kKXzFkhBq6C21QPbL")
